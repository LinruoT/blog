package com.linruot.blog.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.linruot.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.linruot.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
