...
import com.linruot.blog.domain.Article;
import com.linruot.blog.repository.ArticleRepository;
...
/**
 * REST controller for managing {@link com.linruot.blog.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    public ResponseEntity<List<Article>> getAllArticles(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        Page<Article> page = articleRepository.findByBlogUserLoginOrderByDateDesc(SecurityUtils.getCurrentUserLogin().orElse(null),pageable);
